...
ggplot(exam_long, aes(x = Subject, y = Score, fill = GENDER)) +
  ...
  labs(
    title = "Score Distribution students based on Gender",
    subtitle = "Labels shown for students who scored above 90",
    x = "Subject",
    y = "Score"
  ) 
```
