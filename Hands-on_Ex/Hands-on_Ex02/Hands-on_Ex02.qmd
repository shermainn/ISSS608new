...
Pie Chart: Number of Students based on Gender

```{r}
gender_df <- as.data.frame(table(exam_data$GENDER))
...
# Plot
ggplot(avg_english, aes(x = GENDER, y = Avg_English, fill = GENDER)) +
