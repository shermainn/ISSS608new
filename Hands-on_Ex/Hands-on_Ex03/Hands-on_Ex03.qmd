...
animated_plot <- ggplot(hdb_tidy) +
  ...
  theme_minimal() +
  labs(title = "Number of HDB Flats by Planning Area", x = "Planning Area", y = "Number of Flats", fill = "Flat Type") +
  transition_states(flat_type, transition_length = 2, state_length = 1)  # Animation over flat types (adjust accordingly)

animate(animated_plot, nframes = 100, height = 500, width = 800)
```
:::
