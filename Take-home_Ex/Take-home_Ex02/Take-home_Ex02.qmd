...
-   `Sam` seems to be entity that has the most influence among the organizations as Sam has the most edges in terms of communication.
...
-   `The Intern` was talking to the `Boss`, `The Middleman`, `The Lookout` and `Mrs Money` in week 1 whereas `The Intern` was talking to `Mrs Money`, `The Lookout` and `Sam` in week 2.
:::
